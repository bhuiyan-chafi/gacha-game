    ...
    try:
        with transaction.atomic():
            ...
            seller_response = requests.get(
                seller_detail_url, headers=request.headers, verify=False)
            ...
            seller_update_response = requests.put(
                seller_balance_url,
                json={"current_balance": seller_new_balance}, headers=request.headers, verify=False
            )
            ...
            bidder_update_response = requests.put(
                bidder_balance_url,
                json={"current_balance": bidder_new_balance}, headers=request.headers, verify=False
            )
